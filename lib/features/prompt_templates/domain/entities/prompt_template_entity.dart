...
abstract class BuiltInTemplates {
  static List<PromptTemplateEntity> get all => <PromptTemplateEntity>[
    PromptTemplateEntity(
    ...
    PromptTemplateEntity(
      ...
      prompt:
          'Please explain the following concept in simple, easy-to-understand terms, as if explaining to someone with no technical background:\n\n',
      isBuiltIn: true,
      createdAt: DateTime(2024),
    ),
    PromptTemplateEntity(
    ...
    PromptTemplateEntity(
      ...
      prompt:
          'Please help me write or improve the following content. Make it clear, engaging, and professional:\n\n',
      isBuiltIn: true,
      createdAt: DateTime(2024),
    ),
    PromptTemplateEntity(
      ...
      prompt:
          'I need creative ideas about the following topic. Please give me a diverse range of suggestions:\n\n',
      isBuiltIn: true,
      createdAt: DateTime(2024),
    ),
    PromptTemplateEntity(
